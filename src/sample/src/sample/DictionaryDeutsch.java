...
public class DictionaryDeutsch {
    private String[][] dictionary = {
            ...
            {"dreschen", "drischt", "drosch/drasch", "hat gedroschen", "молотить(2prät)"},
            ...
            {"erschrecken", "erschrickt", "erschrak", "hat/ist erschrocken", "(н.гл) испугаться"},
            ...
            {"fliehen", "flieht", "floh", "hat/ist geflohen", "убегать"},
            ...
            {"gebären", "gebiert", "gebar", "hat geboren", "(н.гл) родить"},
            ...
            {"hauen", "haut", "hieb", "hat/ist gehauen", "(н.гл)рубить"},
            ...
            {"kriechen", "kriecht", "kroch", "hat/ist gekrochen", "ползать"},
            ...
            {"löschen", "löscht", "löschte", "hat gelöscht", "тушить, стирать(есть стар.форма)"},
            ...
            {"rennen", "rennt", "rannte", "hat/ist gerannt", "бежать"},
            {"riechen", "riecht", "roch", "hat gerochen", "нюхать"},
            {"ringen", "ringt", "rang", "hat gerungen", "бороться"},
            {"rinnen", "rinnt", "rann", "hat/ist geronnen", "течь"},
            {"rufen", "ruft", "rief", "hat gerufen", "кричать, звать"},
            {"salzen", "salzt", "salzte", "hat gesalzen", "(н.гл) солить"},
            {"saufen", "säuft", "soff", "hat gesoffen", "пьянить"},
            {"saugen", "saugt", "sog", "hat gesogen", "(н.гл)сосать"},
            ...
            {"schieben", "schiebt", "schob", "hat/ist geschoben", "двигать, толкать"},
            ...
            {"schwören", "schwört", "schwor", "hat geschworen", "клясться(u-устар.форма)"},
            {"sehen", "sieht", "sah", "hat gesehen", "смотреть"},
            {"sein", "ist", "war", "ist gewesen", "быть"},
            {"senden", "sendet", "sandte", "hat gesandt", "(н.гл) посылать"},
            ...
            {"wenden", "wendet", "wandte", "hat gewandt", "(н.гл)поворачивать"},
